...
The kenya file is found
[on the Atlas S3](https://digital-atlas.s3.amazonaws.com/digital-atlas/domain=phenology/type=sos_eos/source=glass_nvdi/region=africa/processing=raw/level=adm1/KEN_seasonal-phenology_plus-rain.parquet).
The file name is "KEN_seasonal-phenology_plus-rain.parquet".
...
s3_paths <- s3$dir_ls(
  "digital-atlas/domain=phenology/type=sos_eos/source=glass_nvdi/region=africa/processing=raw/level=adm1/"
)
